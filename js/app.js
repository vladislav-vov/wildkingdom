(() => {
        ...
        on: {
            init: function(slider) {
                slider.slides.forEach((slide => {
                    const imageSrc = slide.querySelector(".hero-slide__img-inner img").getAttribute("src");
                    const topImage = `\n\t\t\t\t\t\t<div class="hero-slide__img-top">\n\t\t\t\t\t\t\t<img src="${imageSrc}" alt="">\n\t\t\t\t\t\t</div>\n\t\t\t\t\t`;
                    const slideContent = slide.querySelector(".hero-slide__img");
    ...
    let formValidate = {
        ...
        addError(formRequiredItem) {
            ...
            if (formRequiredItem.dataset.error) formRequiredItem.closest("form").insertAdjacentHTML("afterbegin", `<div class="form__error">${formRequiredItem.dataset.error}</div>`);
        },
